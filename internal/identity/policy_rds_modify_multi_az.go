...
// BuildRDSModifyMultiAZPolicy returns the minimal session policy for
// toggling Multi-AZ on the named instance.
func BuildRDSModifyMultiAZPolicy(p action.RDSModifyMultiAZProposal, accountID string) SessionPolicy {
